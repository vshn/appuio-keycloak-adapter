...
import (
	...
	controllers "github.com/vshn/appuio-keycloak-adapter/controllers"
)
...
func (m *MockKeycloakPutter) PutGroup(ctx context.Context, group controllers.KeycloakGroup) (controllers.KeycloakGroup, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "PutGroup", ctx, group)
	ret0, _ := ret[0].(controllers.KeycloakGroup)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
